...
Or manually install pywebview:
```bash
pip install pywebview
```

<Callout type="info">
Positron uses **pywebview** for rendering, which provides a real browser engine (WebView2 on Windows, WebKit on macOS, GTK WebKit on Linux). This gives you full React, HTML5, and modern JavaScript support!
</Callout>
